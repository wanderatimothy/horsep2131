...
<aside data-color="info" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
          <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
          <a class="navbar-brand m-0" href="<?= app_url('dashboard') ?>">
              <img src="<?= _asset("assets/img/logo-ct.png") ?>" class="navbar-brand-img h-100" alt="main_logo">
              <span class="ms-1 font-weight-bold h4">E-Estate</span>
          </a>
      </div>
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
          <ul class="navbar-nav">
              <li class="nav-item">
                  <a class="nav-link <?= $data['active']  == 'dashboard' ? 'active' : '' ?>  " href="<?= app_url('dashboard') ?>">
              ...
              <li class="nav-item">
                  <a class="nav-link <?= $data['active']  == 'properties' ? 'active' : '' ?>  " href="<?= app_url('properties') ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                  <a class="nav-link  <?= $data['active']  == 'collections' ? 'active' : '' ?> "     href="<?= app_url("collections") ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                  <a class="nav-link  " href="<?= app_url('tenants') ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <li class="nav-item">
                  <a class="nav-link <?= $data['active'] == 'settings'? 'active' :''  ?>  " href="<?= app_url("settings") ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                  <a class="nav-link  " href="<?= app_url("managers") ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                  <a class="nav-link  " href="<?= app_url("integrations") ?>">
                      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="sidenav-footer mx-3 ">
          <a class="btn bg-gradient-primary mt-4 w-100" href="<?= app_url('upgrade-package') ?>" type="button">Upgrade Package</a>
      </div>
  </aside>